...
$.extend( _dtButtons, {
	collection: {
		...
		action: function ( e, dt, button, config ) {
            ...
            //display column visibility button text title when mouse hover
            var check_boxes = $('.buttons-columnVisibility');
            $.each(check_boxes, function (index, value) {
